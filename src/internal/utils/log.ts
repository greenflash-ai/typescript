...
export const parseLogLevel = (maybeLevel: string | undefined, sourceName: string, client: Greenflash): LogLevel | undefined => {
  if (!maybeLevel) {
    return undefined;
  }
...
export function loggerFor(client: Greenflash): Logger {
